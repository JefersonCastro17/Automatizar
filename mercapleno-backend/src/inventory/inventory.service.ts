...
export class InventoryService {
  ...
  async registerMovement(dto: RegisterMovementDto, userId?: number) {
    ...
    try {
      ...
      // Verificar stock actual contra el umbral establecido
      try {
        const [[productRow]] = await connection.query<any[]>(
        ...
        // eslint-disable-next-line no-console
        console.error('Error al verificar stock o enviar correos:', checkError);
      }
